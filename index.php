                        ...
                        <div class="col-lg-6">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header text-center">
                                    <img class="img-thumbnail" src="assets/img/logo.png" width="200">
                                    <h3 class="font-weight-black  my-4" style="color:#D76454">Iniciar Sesión</h3>
                                </div>
                                <div class="card-body">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <button class="btn btn-outline-danger" style="text-align: center;width:520px" type="submit">Ingresar</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
